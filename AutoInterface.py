#Frame to define the interface of reaction execution
...
tk.Label(fr_cmdInt, width = 75, text = 'Successful example', bg="#8ABCD1", anchor = 'w', justify = tk.LEFT).pack()
tk.Label(fr_cmdInt, width = 75, text = 'Failed example', bg="#E3B4B8", anchor = 'w', justify = tk.LEFT).pack()
...
for i in range(0,2):
        ...
        for j in [0,1]:
            ...
            lbl_millipump_index = ["1","2","3","4","5","6"][i+j*2]
